...
mv dist/dspa-display dist/linux-arm7/
...
mv dist/dspa-display dist/linux-amd64/
...
mv dist/dspa-display dist/darwin-amd64/
...
#mv dist/dspa-display dist/windows-amd64/
